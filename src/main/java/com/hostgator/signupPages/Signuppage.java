...
//		driver.get("https://qa-automation-maintenance-portal.houston1.endurancedevs.com/signup/shared/29/36/SHARED3660/");
//		
//	}
...
//	By i_own_this_domain = By.id("old_domain_tab");
//	By domainName = By.id("domain_field");
//	
//	public WebElement i_own_this_domain_tab()
//	{
//		return driver.findElement(i_own_this_domain);
//	}
//
